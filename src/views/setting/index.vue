    ...
    <Card title="反馈问题">
      <BlockItem :is-link="true">
        <div class="flex-items">
          ...
          <a class="link-style" href="2488548582@qq.com">2488548582@qq.com</a>
          <ICopy style="margin-left: 20px" copy-text="2488548582@qq.com">复制</ICopy>
        </div>
        <template #desc>
...
// const issueLink = 'https://github.com/woshifjr/notes-book/issues';
// const githubLink = 'https://github.com/woshifjr/notes-book';
